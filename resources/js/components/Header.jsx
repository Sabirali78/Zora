...
export default function Header({ auth }) {
  ...
  const navLinks = useMemo(() => [
    { path: '/', label: t('home') },
    {
      ...
      label: t('news'),
      dropdown: [
        { path: '/region/africa', label: t('africa') },
        { path: '/region/asia', label: t('asia') },
        { path: '/region/america', label: t('america') },
        { path: '/region/europe', label: t('europe') },
        { path: '/region/middle-east', label: t('middleEast') }
      ]
    },
    { path: '/country/pakistan', label: t('pakistan') },
    { path: '/category/politics', label: t('politics') },
    { path: '/category/sports', label: t('sports') },
    { path: '/category/technology', label: t('tech') },
    { path: '/category/health', label: t('health') },
    { path: '/category/business', label: t('business') },
    { path: '/category/science', label: t('science') },
    { path: '/category/entertainment', label: t('entertainment') },
    { path: '/category/environment', label: t('environment') },
    { path: '/category/education', label: t('education') },
    { path: '/category/lifestyle', label: t('lifestyle') },
    { path: '/category/arts-culture', label: t('artsCulture') },
    { path: '/category/weather', label: t('weather') },
    { path: '/category/food', label: t('food') },
    { path: '/category/travel', label: t('travel') },
    { path: '/category/fashion', label: t('fashion') }
  ], [t]);
  ...
  >
    ...
    <ChevronDown
      className={`ml-1 h-4 w-4 ${languageDropdownOpen ? 'transform rotate-180' : ''}`}
    />
  </button>
