    ...
    <div className="mb-12">
        ...
        <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/2">
                <Link 
                    href={`/articles/${topStories[0].slug ?? topStories[0].id}`} 
                    ...
                    <div key={type} className="mb-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {articles.map(article => (
                                <Link key={article.id} href={`/articles/${article.slug ?? article.id}`} className="block bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-md transition-shadow duration-300 overflow-hidden">
                                    {getImageUrl(article) && (
                                        <img
